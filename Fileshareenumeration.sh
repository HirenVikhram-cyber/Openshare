...
#Better to avoid IPC C and ADMIN $ shares

cat shares_found1.txt | grep -Ewv 'share|Users|User|user|users|Share|shares|Shares|vault|ftproot|docs|root|Download|reports|FileShare|home|homes|backups|test|Finance|TechnicalSupport|Operations|Home1|Home2|Home3|home1|home2|home3|D|Personal|Department23|IT|Marketing|CorpIT|Backups|PSO|Sales|department30|storage62|department3' | sort -t '\' +3 -u >> shares_filtered1.txt  && cat shares_found1.txt | grep -Ew 'share|Users|User|user|users|Share|shares|Shares|vault|ftproot|docs|root|Download|reports|FileShare|home|homes|Finance|TechnicalSupport|Operations|Home1|Home2|Home3|home1|home2|home3|D|Personal' | tee -a shares_filtered1.txt

#These 4 steps are for reducing the False Positives.

cat shares_found2.txt | grep -Ewv 'share|Users|User|user|users|Share|shares|Shares|vault|ftproot|docs|root|Download|reports|FileShare|home|homes|backups|test|Finance|TechnicalSupport|Operations|Home1|Home2|Home3|home1|home2|home3|D|Personal' | sort -t '\' +3 -u >> shares_filtered2.txt && cat shares_found2.txt | grep -Ew 'share|Users|User|user|users|Share|shares|Shares|vault|ftproot|docs|root|Download|reports|FileShare|home|homes|Finance|TechnicalSupport|Operations|Home1|Home2|Home3|home1|home2|home3|D|Personal' | tee -a shares_filtered2.txt



cat shares_found3.txt | grep -Ewv 'share|Users|User|user|users|Share|shares|Shares|vault|ftproot|docs|root|Download|reports|FileShare|home|homes|backups|test|Finance|TechnicalSupport|Operations|Home1|Home2|Home3|home1|home2|home3|D|Personal' | sort -t '\' +3 -u >> shares_filtered3pre.txt && cat shares_found3.txt | grep -Ew 'share|Users|User|user|users|Share|shares|Shares|vault|ftproot|docs|root|Download|reports|FileShare|home|homes|Finance|TechnicalSupport|Operations|Home1|Home2|Home3|home1|home2|home3|D|Personal' >> shares_filtered3pre.txt &&  cat shares_filtered3pre.txt  | grep -Ewv  '10\.162\.202|10\.162\.203|10\.166\.2|10\.166\.7|10\.188\.3|10\.188\.76|10\.188\.29|10\.188\.4|10\.190\.2|10\.190\.3' >> shares_filtered3.txt && cat shares_filtered3pre.txt | grep -Ew '10\.162\.202\.11|10\.166\.2\.21|10\.188\.3\.121|10\.188\.29\.15|10\.190\.2\.101' | tee -a shares_filtered3.txt



cat shares_found4.txt | grep -Ewv 'share|Users|User|user|users|Share|shares|Shares|vault|ftproot|docs|root|Download|reports|FileShare|home|homes|backups|test|Finance|TechnicalSupport|Operations|Home1|Home2|Home3|home1|home2|home3|D|Personal' | sort -t '\' +3 -u >> shares_filtered4.txt && cat shares_found4.txt | grep -Ew 'share|Users|User|user|users|Share|shares|Shares|vault|ftproot|docs|root|Download|reports|FileShare|home|homes|Finance|TechnicalSupport|Operations|Home1|Home2|Home3|home1|home2|home3|D|Personal' | tee -a shares_filtered4.txt
